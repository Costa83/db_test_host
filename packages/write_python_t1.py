...
database_name='test_influxdb_python3'

client = InfluxDBClient(host='10.18.3.185', port=8086)
...
client.write_points(data, database=database_name, time_precision='ms', batch_size=10000, protocol='line')
